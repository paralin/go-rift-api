...
// GcloudVoiceChatRsoAuthorizationResource gcloud voice chat rso authorization resource
// swagger:model GcloudVoiceChatRsoAuthorizationResource
...
func (m *GcloudVoiceChatRsoAuthorizationResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *GcloudVoiceChatRsoAuthorizationResource) UnmarshalBinary(b []byte) error {
	var res GcloudVoiceChatRsoAuthorizationResource
