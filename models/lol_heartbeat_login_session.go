...
// LolHeartbeatLoginSession lol heartbeat login session
// swagger:model LolHeartbeatLoginSession
...
func (m *LolHeartbeatLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolHeartbeatLoginSession) UnmarshalBinary(b []byte) error {
	var res LolHeartbeatLoginSession
