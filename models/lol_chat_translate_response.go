...
// LolChatTranslateResponse lol chat translate response
// swagger:model LolChatTranslateResponse
...
func (m *LolChatTranslateResponse) validateResults(formats strfmt.Registry) error {
...
func (m *LolChatTranslateResponse) UnmarshalBinary(b []byte) error {
	var res LolChatTranslateResponse
