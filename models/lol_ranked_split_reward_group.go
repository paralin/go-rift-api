...
// LolRankedSplitRewardGroup lol ranked split reward group
// swagger:model LolRankedSplitRewardGroup
...
func (m *LolRankedSplitRewardGroup) validateRewards(formats strfmt.Registry) error {
...
func (m *LolRankedSplitRewardGroup) UnmarshalBinary(b []byte) error {
	var res LolRankedSplitRewardGroup
