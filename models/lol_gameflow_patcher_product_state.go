...
// LolGameflowPatcherProductState lol gameflow patcher product state
// swagger:model LolGameflowPatcherProductState
...
func (m *LolGameflowPatcherProductState) validateAction(formats strfmt.Registry) error {
...
func (m *LolGameflowPatcherProductState) UnmarshalBinary(b []byte) error {
	var res LolGameflowPatcherProductState
