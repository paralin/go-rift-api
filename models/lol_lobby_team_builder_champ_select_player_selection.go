...
// LolLobbyTeamBuilderChampSelectPlayerSelection lol lobby team builder champ select player selection
// swagger:model LolLobbyTeamBuilderChampSelectPlayerSelection
...
func (m *LolLobbyTeamBuilderChampSelectPlayerSelection) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *LolLobbyTeamBuilderChampSelectPlayerSelection) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LolLobbyTeamBuilderChampSelectPlayerSelection) UnmarshalBinary(b []byte) error {
	var res LolLobbyTeamBuilderChampSelectPlayerSelection
