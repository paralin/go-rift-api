...
// LolLoadoutsScopedLoadout lol loadouts scoped loadout
// swagger:model LolLoadoutsScopedLoadout
...
func (m *LolLoadoutsScopedLoadout) validateLoadout(formats strfmt.Registry) error {
...
func (m *LolLoadoutsScopedLoadout) UnmarshalBinary(b []byte) error {
	var res LolLoadoutsScopedLoadout
