...
// LolModeProgressionLoadout lol mode progression loadout
// swagger:model LolModeProgressionLoadout
...
func (m *LolModeProgressionLoadout) validateLoadout(formats strfmt.Registry) error {
...
func (m *LolModeProgressionLoadout) UnmarshalBinary(b []byte) error {
	var res LolModeProgressionLoadout
