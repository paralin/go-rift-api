...
// LolCollectionsPlayerNotification lol collections player notification
// swagger:model LolCollectionsPlayerNotification
...
func (m *LolCollectionsPlayerNotification) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolCollectionsPlayerNotification) UnmarshalBinary(b []byte) error {
	var res LolCollectionsPlayerNotification
