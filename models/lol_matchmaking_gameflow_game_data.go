...
// LolMatchmakingGameflowGameData lol matchmaking gameflow game data
// swagger:model LolMatchmakingGameflowGameData
...
func (m *LolMatchmakingGameflowGameData) validateQueue(formats strfmt.Registry) error {
...
func (m *LolMatchmakingGameflowGameData) UnmarshalBinary(b []byte) error {
	var res LolMatchmakingGameflowGameData
