...
// LolClashMatchmakingDodgeData lol clash matchmaking dodge data
// swagger:model LolClashMatchmakingDodgeData
...
func (m *LolClashMatchmakingDodgeData) validateState(formats strfmt.Registry) error {
...
func (m *LolClashMatchmakingDodgeData) UnmarshalBinary(b []byte) error {
	var res LolClashMatchmakingDodgeData
