...
// VoiceChatUpdateSettingsResource voice chat update settings resource
// swagger:model VoiceChatUpdateSettingsResource
...
func (m *VoiceChatUpdateSettingsResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *VoiceChatUpdateSettingsResource) UnmarshalBinary(b []byte) error {
	var res VoiceChatUpdateSettingsResource
