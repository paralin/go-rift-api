...
// LolCosmeticsLoadout lol cosmetics loadout
// swagger:model LolCosmeticsLoadout
...
func (m *LolCosmeticsLoadout) validateLoadout(formats strfmt.Registry) error {
