...
// LolGameQueuesQueue lol game queues queue
// swagger:model LolGameQueuesQueue
...
func (m *LolGameQueuesQueue) validateCategory(formats strfmt.Registry) error {
...
func (m *LolGameQueuesQueue) validateGameTypeConfig(formats strfmt.Registry) error {
...
func (m *LolGameQueuesQueue) validateQueueAvailability(formats strfmt.Registry) error {
...
func (m *LolGameQueuesQueue) validateQueueRewards(formats strfmt.Registry) error {
