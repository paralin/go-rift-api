...
// LolRankedGameflowSession lol ranked gameflow session
// swagger:model LolRankedGameflowSession
...
func (m *LolRankedGameflowSession) validateGameData(formats strfmt.Registry) error {
...
func (m *LolRankedGameflowSession) validatePhase(formats strfmt.Registry) error {
...
func (m *LolRankedGameflowSession) UnmarshalBinary(b []byte) error {
	var res LolRankedGameflowSession
