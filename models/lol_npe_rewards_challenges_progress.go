...
// LolNpeRewardsChallengesProgress lol npe rewards challenges progress
// swagger:model LolNpeRewardsChallengesProgress
...
func (m *LolNpeRewardsChallengesProgress) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolNpeRewardsChallengesProgress) validateProgress(formats strfmt.Registry) error {
...
func (m *LolNpeRewardsChallengesProgress) UnmarshalBinary(b []byte) error {
	var res LolNpeRewardsChallengesProgress
