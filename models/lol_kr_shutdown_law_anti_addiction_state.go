...
// LolKrShutdownLawAntiAddictionState lol kr shutdown law anti addiction state
// swagger:model LolKrShutdownLawAntiAddictionState
...
func (m *LolKrShutdownLawAntiAddictionState) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolKrShutdownLawAntiAddictionState) validatePolicyType(formats strfmt.Registry) error {
...
func (m *LolKrShutdownLawAntiAddictionState) UnmarshalBinary(b []byte) error {
	var res LolKrShutdownLawAntiAddictionState
