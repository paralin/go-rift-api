...
// LolCollectionsCollectionsOwnership lol collections collections ownership
// swagger:model LolCollectionsCollectionsOwnership
...
func (m *LolCollectionsCollectionsOwnership) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolCollectionsCollectionsOwnership) validateRental(formats strfmt.Registry) error {
...
func (m *LolCollectionsCollectionsOwnership) UnmarshalBinary(b []byte) error {
	var res LolCollectionsCollectionsOwnership
