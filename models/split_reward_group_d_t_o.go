...
// SplitRewardGroupDTO split reward group d t o
// swagger:model SplitRewardGroupDTO
...
func (m *SplitRewardGroupDTO) validateRewards(formats strfmt.Registry) error {
