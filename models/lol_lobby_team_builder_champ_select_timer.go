...
// LolLobbyTeamBuilderChampSelectTimer lol lobby team builder champ select timer
// swagger:model LolLobbyTeamBuilderChampSelectTimer
...
func (m *LolLobbyTeamBuilderChampSelectTimer) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolLobbyTeamBuilderChampSelectTimer) UnmarshalBinary(b []byte) error {
	var res LolLobbyTeamBuilderChampSelectTimer
