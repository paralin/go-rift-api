...
// MatchmakingLcdsQueueThrottled matchmaking lcds queue throttled
// swagger:model MatchmakingLcdsQueueThrottled
...
func (m *MatchmakingLcdsQueueThrottled) validateSummoner(formats strfmt.Registry) error {
...
func (m *MatchmakingLcdsQueueThrottled) UnmarshalBinary(b []byte) error {
	var res MatchmakingLcdsQueueThrottled
