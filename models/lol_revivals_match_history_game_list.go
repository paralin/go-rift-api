...
// LolRevivalsMatchHistoryGameList lol revivals match history game list
// swagger:model LolRevivalsMatchHistoryGameList
...
func (m *LolRevivalsMatchHistoryGameList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolRevivalsMatchHistoryGameList) validateGames(formats strfmt.Registry) error {
...
func (m *LolRevivalsMatchHistoryGameList) UnmarshalBinary(b []byte) error {
	var res LolRevivalsMatchHistoryGameList
