...
// LolChampSelectLegacyChampSelectMySelection lol champ select legacy champ select my selection
// swagger:model LolChampSelectLegacyChampSelectMySelection
...
func (m *LolChampSelectLegacyChampSelectMySelection) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolChampSelectLegacyChampSelectMySelection) UnmarshalBinary(b []byte) error {
	var res LolChampSelectLegacyChampSelectMySelection
