...
// LolLobbyTeamBuilderChampSelectMySelection lol lobby team builder champ select my selection
// swagger:model LolLobbyTeamBuilderChampSelectMySelection
...
func (m *LolLobbyTeamBuilderChampSelectMySelection) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolLobbyTeamBuilderChampSelectMySelection) UnmarshalBinary(b []byte) error {
	var res LolLobbyTeamBuilderChampSelectMySelection
