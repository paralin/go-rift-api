...
// LolInventoryWalletResponseDTO lol inventory wallet response d t o
// swagger:model LolInventoryWalletResponseDTO
...
func (m *LolInventoryWalletResponseDTO) validateData(formats strfmt.Registry) error {
...
func (m *LolInventoryWalletResponseDTO) UnmarshalBinary(b []byte) error {
	var res LolInventoryWalletResponseDTO
