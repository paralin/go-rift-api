...
// LolMatchmakingLoginSession lol matchmaking login session
// swagger:model LolMatchmakingLoginSession
...
func (m *LolMatchmakingLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolMatchmakingLoginSession) UnmarshalBinary(b []byte) error {
	var res LolMatchmakingLoginSession
