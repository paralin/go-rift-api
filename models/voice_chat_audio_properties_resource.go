...
// VoiceChatAudioPropertiesResource voice chat audio properties resource
// swagger:model VoiceChatAudioPropertiesResource
...
func (m *VoiceChatAudioPropertiesResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *VoiceChatAudioPropertiesResource) UnmarshalBinary(b []byte) error {
	var res VoiceChatAudioPropertiesResource
