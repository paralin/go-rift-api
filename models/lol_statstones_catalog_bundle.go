...
// LolStatstonesCatalogBundle lol statstones catalog bundle
// swagger:model LolStatstonesCatalogBundle
...
func (m *LolStatstonesCatalogBundle) validateItem(formats strfmt.Registry) error {
...
func (m *LolStatstonesCatalogBundle) UnmarshalBinary(b []byte) error {
	var res LolStatstonesCatalogBundle
