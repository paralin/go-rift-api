...
// LolRankedEosRewardsConfig lol ranked eos rewards config
// swagger:model LolRankedEosRewardsConfig
...
func (m *LolRankedEosRewardsConfig) validateConfig(formats strfmt.Registry) error {
...
func (m *LolRankedEosRewardsConfig) UnmarshalBinary(b []byte) error {
	var res LolRankedEosRewardsConfig
