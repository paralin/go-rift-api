...
// LolInventoryRmsEntitlementPayload lol inventory rms entitlement payload
// swagger:model LolInventoryRmsEntitlementPayload
...
func (m *LolInventoryRmsEntitlementPayload) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolInventoryRmsEntitlementPayload) UnmarshalBinary(b []byte) error {
	var res LolInventoryRmsEntitlementPayload
