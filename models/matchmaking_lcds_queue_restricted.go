...
// MatchmakingLcdsQueueRestricted matchmaking lcds queue restricted
// swagger:model MatchmakingLcdsQueueRestricted
...
func (m *MatchmakingLcdsQueueRestricted) validateSummoner(formats strfmt.Registry) error {
...
func (m *MatchmakingLcdsQueueRestricted) UnmarshalBinary(b []byte) error {
	var res MatchmakingLcdsQueueRestricted
