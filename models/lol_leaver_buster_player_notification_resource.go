...
// LolLeaverBusterPlayerNotificationResource lol leaver buster player notification resource
// swagger:model LolLeaverBusterPlayerNotificationResource
...
func (m *LolLeaverBusterPlayerNotificationResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolLeaverBusterPlayerNotificationResource) UnmarshalBinary(b []byte) error {
	var res LolLeaverBusterPlayerNotificationResource
