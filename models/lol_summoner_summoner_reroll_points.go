...
// LolSummonerSummonerRerollPoints lol summoner summoner reroll points
// swagger:model LolSummonerSummonerRerollPoints
...
func (m *LolSummonerSummonerRerollPoints) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolSummonerSummonerRerollPoints) UnmarshalBinary(b []byte) error {
	var res LolSummonerSummonerRerollPoints
