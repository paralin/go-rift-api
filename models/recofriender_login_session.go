...
// RecofrienderLoginSession recofriender login session
// swagger:model RecofrienderLoginSession
...
func (m *RecofrienderLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *RecofrienderLoginSession) UnmarshalBinary(b []byte) error {
	var res RecofrienderLoginSession
