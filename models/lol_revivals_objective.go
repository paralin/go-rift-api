...
// LolRevivalsObjective lol revivals objective
// swagger:model LolRevivalsObjective
...
func (m *LolRevivalsObjective) validateProgress(formats strfmt.Registry) error {
