...
// LolChatFriendRequestList lol chat friend request list
// swagger:model LolChatFriendRequestList
...
func (m *LolChatFriendRequestList) validateRequests(formats strfmt.Registry) error {
...
func (m *LolChatFriendRequestList) UnmarshalBinary(b []byte) error {
	var res LolChatFriendRequestList
