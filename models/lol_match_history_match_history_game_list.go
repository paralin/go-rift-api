...
// LolMatchHistoryMatchHistoryGameList lol match history match history game list
// swagger:model LolMatchHistoryMatchHistoryGameList
...
func (m *LolMatchHistoryMatchHistoryGameList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolMatchHistoryMatchHistoryGameList) validateGames(formats strfmt.Registry) error {
...
func (m *LolMatchHistoryMatchHistoryGameList) UnmarshalBinary(b []byte) error {
	var res LolMatchHistoryMatchHistoryGameList
