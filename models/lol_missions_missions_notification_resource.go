...
// LolMissionsMissionsNotificationResource lol missions missions notification resource
// swagger:model LolMissionsMissionsNotificationResource
...
func (m *LolMissionsMissionsNotificationResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolMissionsMissionsNotificationResource) UnmarshalBinary(b []byte) error {
	var res LolMissionsMissionsNotificationResource
