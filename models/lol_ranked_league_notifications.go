...
// LolRankedLeagueNotifications lol ranked league notifications
// swagger:model LolRankedLeagueNotifications
...
func (m *LolRankedLeagueNotifications) validateNotifications(formats strfmt.Registry) error {
...
func (m *LolRankedLeagueNotifications) UnmarshalBinary(b []byte) error {
	var res LolRankedLeagueNotifications
