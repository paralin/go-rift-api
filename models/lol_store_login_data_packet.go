...
// LolStoreLoginDataPacket lol store login data packet
// swagger:model LolStoreLoginDataPacket
...
func (m *LolStoreLoginDataPacket) validateAllSummonerData(formats strfmt.Registry) error {
...
func (m *LolStoreLoginDataPacket) validateSimpleMessages(formats strfmt.Registry) error {
...
func (m *LolStoreLoginDataPacket) UnmarshalBinary(b []byte) error {
	var res LolStoreLoginDataPacket
