...
// LolStorePageGroupingDTO lol store page grouping d t o
// swagger:model LolStorePageGroupingDTO
...
func (m *LolStorePageGroupingDTO) validateItems(formats strfmt.Registry) error {
...
func (m *LolStorePageGroupingDTO) UnmarshalBinary(b []byte) error {
	var res LolStorePageGroupingDTO
