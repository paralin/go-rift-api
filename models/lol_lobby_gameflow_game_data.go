...
// LolLobbyGameflowGameData lol lobby gameflow game data
// swagger:model LolLobbyGameflowGameData
...
func (m *LolLobbyGameflowGameData) validateQueue(formats strfmt.Registry) error {
...
func (m *LolLobbyGameflowGameData) UnmarshalBinary(b []byte) error {
	var res LolLobbyGameflowGameData
