...
// LolLoyaltyInventoryResponseDTO lol loyalty inventory response d t o
// swagger:model LolLoyaltyInventoryResponseDTO
...
func (m *LolLoyaltyInventoryResponseDTO) validateData(formats strfmt.Registry) error {
...
func (m *LolLoyaltyInventoryResponseDTO) UnmarshalBinary(b []byte) error {
	var res LolLoyaltyInventoryResponseDTO
