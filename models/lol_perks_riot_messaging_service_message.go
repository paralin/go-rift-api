...
// LolPerksRiotMessagingServiceMessage lol perks riot messaging service message
// swagger:model LolPerksRiotMessagingServiceMessage
...
func (m *LolPerksRiotMessagingServiceMessage) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolPerksRiotMessagingServiceMessage) UnmarshalBinary(b []byte) error {
	var res LolPerksRiotMessagingServiceMessage
