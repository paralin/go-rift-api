...
// ExternalPluginsResource external plugins resource
// swagger:model ExternalPluginsResource
...
func (m *ExternalPluginsResource) validateState(formats strfmt.Registry) error {
...
func (m *ExternalPluginsResource) UnmarshalBinary(b []byte) error {
	var res ExternalPluginsResource
