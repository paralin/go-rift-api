...
// LolLoadoutsLoginSession lol loadouts login session
// swagger:model LolLoadoutsLoginSession
...
func (m *LolLoadoutsLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolLoadoutsLoginSession) UnmarshalBinary(b []byte) error {
	var res LolLoadoutsLoginSession
