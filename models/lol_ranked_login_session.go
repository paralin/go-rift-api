...
// LolRankedLoginSession lol ranked login session
// swagger:model LolRankedLoginSession
...
func (m *LolRankedLoginSession) validateState(formats strfmt.Registry) error {
