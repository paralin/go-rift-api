...
// LolSuggestedPlayersEndOfGamePlayer lol suggested players end of game player
// swagger:model LolSuggestedPlayersEndOfGamePlayer
...
func (m *LolSuggestedPlayersEndOfGamePlayer) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolSuggestedPlayersEndOfGamePlayer) UnmarshalBinary(b []byte) error {
	var res LolSuggestedPlayersEndOfGamePlayer
