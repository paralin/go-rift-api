...
// LolPerksLoginSession lol perks login session
// swagger:model LolPerksLoginSession
...
func (m *LolPerksLoginSession) validateState(formats strfmt.Registry) error {
