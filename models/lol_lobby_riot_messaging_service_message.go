...
// LolLobbyRiotMessagingServiceMessage lol lobby riot messaging service message
// swagger:model LolLobbyRiotMessagingServiceMessage
...
func (m *LolLobbyRiotMessagingServiceMessage) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolLobbyRiotMessagingServiceMessage) UnmarshalBinary(b []byte) error {
	var res LolLobbyRiotMessagingServiceMessage
