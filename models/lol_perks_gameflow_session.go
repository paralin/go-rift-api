...
// LolPerksGameflowSession lol perks gameflow session
// swagger:model LolPerksGameflowSession
...
func (m *LolPerksGameflowSession) validateGameData(formats strfmt.Registry) error {
...
func (m *LolPerksGameflowSession) validatePhase(formats strfmt.Registry) error {
...
func (m *LolPerksGameflowSession) UnmarshalBinary(b []byte) error {
	var res LolPerksGameflowSession
