...
// LolLobbyLoginSession lol lobby login session
// swagger:model LolLobbyLoginSession
...
func (m *LolLobbyLoginSession) validateState(formats strfmt.Registry) error {
