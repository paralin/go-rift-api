...
// LolChampSelectCollectionsOwnership lol champ select collections ownership
// swagger:model LolChampSelectCollectionsOwnership
...
func (m *LolChampSelectCollectionsOwnership) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolChampSelectCollectionsOwnership) validateRental(formats strfmt.Registry) error {
...
func (m *LolChampSelectCollectionsOwnership) UnmarshalBinary(b []byte) error {
	var res LolChampSelectCollectionsOwnership
