...
// LolLeaverBusterLoginDataPacket lol leaver buster login data packet
// swagger:model LolLeaverBusterLoginDataPacket
...
func (m *LolLeaverBusterLoginDataPacket) validateAllSummonerData(formats strfmt.Registry) error {
...
func (m *LolLeaverBusterLoginDataPacket) validateSimpleMessages(formats strfmt.Registry) error {
...
func (m *LolLeaverBusterLoginDataPacket) UnmarshalBinary(b []byte) error {
	var res LolLeaverBusterLoginDataPacket
