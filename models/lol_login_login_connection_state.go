...
// LolLoginLoginConnectionState lol login login connection state
// swagger:model LolLoginLoginConnectionState
...
func (m *LolLoginLoginConnectionState) validateMode(formats strfmt.Registry) error {
...
func (m *LolLoginLoginConnectionState) UnmarshalBinary(b []byte) error {
	var res LolLoginLoginConnectionState
