...
// LolHonorV2LoginSession lol honor v2 login session
// swagger:model LolHonorV2LoginSession
...
func (m *LolHonorV2LoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolHonorV2LoginSession) UnmarshalBinary(b []byte) error {
	var res LolHonorV2LoginSession
