...
// LolGameflowQueue lol gameflow queue
// swagger:model LolGameflowQueue
...
func (m *LolGameflowQueue) validateCategory(formats strfmt.Registry) error {
...
func (m *LolGameflowQueue) validateGameTypeConfig(formats strfmt.Registry) error {
...
func (m *LolGameflowQueue) validateQueueAvailability(formats strfmt.Registry) error {
...
func (m *LolGameflowQueue) validateQueueRewards(formats strfmt.Registry) error {
