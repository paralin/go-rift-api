...
// LolLobbyQueue lol lobby queue
// swagger:model LolLobbyQueue
...
func (m *LolLobbyQueue) validateCategory(formats strfmt.Registry) error {
...
func (m *LolLobbyQueue) validateGameTypeConfig(formats strfmt.Registry) error {
...
func (m *LolLobbyQueue) validateQueueAvailability(formats strfmt.Registry) error {
...
func (m *LolLobbyQueue) validateQueueRewards(formats strfmt.Registry) error {
