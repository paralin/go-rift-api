...
// LolDisambiguationConfigStatus lol disambiguation config status
// swagger:model LolDisambiguationConfigStatus
...
func (m *LolDisambiguationConfigStatus) validateReadiness(formats strfmt.Registry) error {
...
func (m *LolDisambiguationConfigStatus) UnmarshalBinary(b []byte) error {
	var res LolDisambiguationConfigStatus
