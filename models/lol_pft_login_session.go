...
// LolPftLoginSession lol pft login session
// swagger:model LolPftLoginSession
...
func (m *LolPftLoginSession) validateState(formats strfmt.Registry) error {
