...
// LolChatParticipantList lol chat participant list
// swagger:model LolChatParticipantList
...
func (m *LolChatParticipantList) validateParticipants(formats strfmt.Registry) error {
...
func (m *LolChatParticipantList) UnmarshalBinary(b []byte) error {
	var res LolChatParticipantList
