...
// LolChampionsGameDataChampionSpell lol champions game data champion spell
// swagger:model LolChampionsGameDataChampionSpell
...
func (m *LolChampionsGameDataChampionSpell) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolChampionsGameDataChampionSpell) UnmarshalBinary(b []byte) error {
	var res LolChampionsGameDataChampionSpell
