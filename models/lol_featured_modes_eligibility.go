...
// LolFeaturedModesEligibility lol featured modes eligibility
// swagger:model LolFeaturedModesEligibility
...
func (m *LolFeaturedModesEligibility) validateRestrictions(formats strfmt.Registry) error {
...
func (m *LolFeaturedModesEligibility) UnmarshalBinary(b []byte) error {
	var res LolFeaturedModesEligibility
