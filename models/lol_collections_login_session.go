...
// LolCollectionsLoginSession lol collections login session
// swagger:model LolCollectionsLoginSession
...
func (m *LolCollectionsLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolCollectionsLoginSession) UnmarshalBinary(b []byte) error {
	var res LolCollectionsLoginSession
