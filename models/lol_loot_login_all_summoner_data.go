...
// LolLootLoginAllSummonerData lol loot login all summoner data
// swagger:model LolLootLoginAllSummonerData
...
func (m *LolLootLoginAllSummonerData) validateSummonerLevelAndPoints(formats strfmt.Registry) error {
...
func (m *LolLootLoginAllSummonerData) UnmarshalBinary(b []byte) error {
	var res LolLootLoginAllSummonerData
