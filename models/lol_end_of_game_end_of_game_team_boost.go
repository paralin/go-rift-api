...
// LolEndOfGameEndOfGameTeamBoost lol end of game end of game team boost
// swagger:model LolEndOfGameEndOfGameTeamBoost
...
func (m *LolEndOfGameEndOfGameTeamBoost) UnmarshalBinary(b []byte) error {
	var res LolEndOfGameEndOfGameTeamBoost
