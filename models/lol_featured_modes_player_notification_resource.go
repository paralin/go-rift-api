...
// LolFeaturedModesPlayerNotificationResource lol featured modes player notification resource
// swagger:model LolFeaturedModesPlayerNotificationResource
...
func (m *LolFeaturedModesPlayerNotificationResource) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolFeaturedModesPlayerNotificationResource) UnmarshalBinary(b []byte) error {
	var res LolFeaturedModesPlayerNotificationResource
