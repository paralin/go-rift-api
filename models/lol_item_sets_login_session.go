...
// LolItemSetsLoginSession lol item sets login session
// swagger:model LolItemSetsLoginSession
...
func (m *LolItemSetsLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolItemSetsLoginSession) UnmarshalBinary(b []byte) error {
	var res LolItemSetsLoginSession
