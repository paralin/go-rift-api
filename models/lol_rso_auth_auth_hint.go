...
// LolRsoAuthAuthHint lol rso auth auth hint
// swagger:model LolRsoAuthAuthHint
...
func (m *LolRsoAuthAuthHint) validateType(formats strfmt.Registry) error {
