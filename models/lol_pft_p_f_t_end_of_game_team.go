...
// LolPftPFTEndOfGameTeam lol pft p f t end of game team
// swagger:model LolPftPFTEndOfGameTeam
...
func (m *LolPftPFTEndOfGameTeam) validatePlayers(formats strfmt.Registry) error {
...
func (m *LolPftPFTEndOfGameTeam) UnmarshalBinary(b []byte) error {
	var res LolPftPFTEndOfGameTeam
