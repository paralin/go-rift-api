...
// LolChatChatPlatformLoginSession lol chat chat platform login session
// swagger:model LolChatChatPlatformLoginSession
...
func (m *LolChatChatPlatformLoginSession) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolChatChatPlatformLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolChatChatPlatformLoginSession) UnmarshalBinary(b []byte) error {
	var res LolChatChatPlatformLoginSession
