...
// LolInventoryInventoryItem lol inventory inventory item
// swagger:model LolInventoryInventoryItem
...
func (m *LolInventoryInventoryItem) validateOwnershipType(formats strfmt.Registry) error {
...
func (m *LolInventoryInventoryItem) UnmarshalBinary(b []byte) error {
	var res LolInventoryInventoryItem
