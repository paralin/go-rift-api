...
// LolRankedEosNotificationsConfig lol ranked eos notifications config
// swagger:model LolRankedEosNotificationsConfig
...
func (m *LolRankedEosNotificationsConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolRankedEosNotificationsConfig) validateConfig(formats strfmt.Registry) error {
...
func (m *LolRankedEosNotificationsConfig) UnmarshalBinary(b []byte) error {
	var res LolRankedEosNotificationsConfig
