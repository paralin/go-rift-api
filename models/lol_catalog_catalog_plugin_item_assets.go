...
// LolCatalogCatalogPluginItemAssets lol catalog catalog plugin item assets
// swagger:model LolCatalogCatalogPluginItemAssets
...
func (m *LolCatalogCatalogPluginItemAssets) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolCatalogCatalogPluginItemAssets) validateEmblems(formats strfmt.Registry) error {
...
func (m *LolCatalogCatalogPluginItemAssets) UnmarshalBinary(b []byte) error {
	var res LolCatalogCatalogPluginItemAssets
