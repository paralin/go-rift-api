...
// LolRegaliaRegaliaWithPreferences lol regalia regalia with preferences
// swagger:model LolRegaliaRegaliaWithPreferences
...
func (m *LolRegaliaRegaliaWithPreferences) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolRegaliaRegaliaWithPreferences) validateHighestRankedEntry(formats strfmt.Registry) error {
...
func (m *LolRegaliaRegaliaWithPreferences) validateLastSeasonHighestRank(formats strfmt.Registry) error {
...
func (m *LolRegaliaRegaliaWithPreferences) UnmarshalBinary(b []byte) error {
	var res LolRegaliaRegaliaWithPreferences
