...
// LolPremadeVoiceGameflowGameClient lol premade voice gameflow game client
// swagger:model LolPremadeVoiceGameflowGameClient
...
func (m *LolPremadeVoiceGameflowGameClient) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolPremadeVoiceGameflowGameClient) UnmarshalBinary(b []byte) error {
	var res LolPremadeVoiceGameflowGameClient
