...
// LolMatchmakingGameflowGameDodge lol matchmaking gameflow game dodge
// swagger:model LolMatchmakingGameflowGameDodge
...
func (m *LolMatchmakingGameflowGameDodge) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolMatchmakingGameflowGameDodge) validateState(formats strfmt.Registry) error {
...
func (m *LolMatchmakingGameflowGameDodge) UnmarshalBinary(b []byte) error {
	var res LolMatchmakingGameflowGameDodge
