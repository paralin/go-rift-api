...
// GcloudVoiceChatSessionResource gcloud voice chat session resource
// swagger:model GcloudVoiceChatSessionResource
...
func (m *GcloudVoiceChatSessionResource) validateParticipants(formats strfmt.Registry) error {
...
func (m *GcloudVoiceChatSessionResource) validateStatus(formats strfmt.Registry) error {
...
func (m *GcloudVoiceChatSessionResource) UnmarshalBinary(b []byte) error {
	var res GcloudVoiceChatSessionResource
