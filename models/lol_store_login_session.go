...
// LolStoreLoginSession lol store login session
// swagger:model LolStoreLoginSession
...
func (m *LolStoreLoginSession) validateState(formats strfmt.Registry) error {
