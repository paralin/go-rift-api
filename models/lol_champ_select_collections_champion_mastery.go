...
// LolChampSelectCollectionsChampionMastery lol champ select collections champion mastery
// swagger:model LolChampSelectCollectionsChampionMastery
...
func (m *LolChampSelectCollectionsChampionMastery) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolChampSelectCollectionsChampionMastery) UnmarshalBinary(b []byte) error {
	var res LolChampSelectCollectionsChampionMastery
