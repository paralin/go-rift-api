...
// LolPurchaseWidgetCatalogPluginItemWithDetails lol purchase widget catalog plugin item with details
// swagger:model LolPurchaseWidgetCatalogPluginItemWithDetails
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateAssets(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateBundledDiscountPrices(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateBundledItems(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateItem(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateMinimumBundlePrices(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) validateRequiredItems(formats strfmt.Registry) error {
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LolPurchaseWidgetCatalogPluginItemWithDetails) UnmarshalBinary(b []byte) error {
	var res LolPurchaseWidgetCatalogPluginItemWithDetails
