...
// LolLobbyLobbyLastQueuedLobby lol lobby lobby last queued lobby
// swagger:model LolLobbyLobbyLastQueuedLobby
...
func (m *LolLobbyLobbyLastQueuedLobby) validateMembers(formats strfmt.Registry) error {
...
func (m *LolLobbyLobbyLastQueuedLobby) UnmarshalBinary(b []byte) error {
	var res LolLobbyLobbyLastQueuedLobby
