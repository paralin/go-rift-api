...
// PlayerBehaviorLcdsSimpleMessage player behavior lcds simple message
// swagger:model PlayerBehaviorLcdsSimpleMessage
...
func (m *PlayerBehaviorLcdsSimpleMessage) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *PlayerBehaviorLcdsSimpleMessage) UnmarshalBinary(b []byte) error {
	var res PlayerBehaviorLcdsSimpleMessage
