...
// LolCatalogChampionSkinEmblemPath lol catalog champion skin emblem path
// swagger:model LolCatalogChampionSkinEmblemPath
...
func (m *LolCatalogChampionSkinEmblemPath) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *LolCatalogChampionSkinEmblemPath) UnmarshalBinary(b []byte) error {
	var res LolCatalogChampionSkinEmblemPath
