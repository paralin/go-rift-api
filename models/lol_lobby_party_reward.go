...
// LolLobbyPartyReward lol lobby party reward
// swagger:model LolLobbyPartyReward
...
func (m *LolLobbyPartyReward) validateType(formats strfmt.Registry) error {
