...
// swagger:model BindingFullApiHelp
...
func (m *BindingFullAPIHelp) validateEvents(formats strfmt.Registry) error {
...
func (m *BindingFullAPIHelp) validateFunctions(formats strfmt.Registry) error {
...
func (m *BindingFullAPIHelp) validateTypes(formats strfmt.Registry) error {
