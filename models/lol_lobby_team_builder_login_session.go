...
// LolLobbyTeamBuilderLoginSession lol lobby team builder login session
// swagger:model LolLobbyTeamBuilderLoginSession
...
func (m *LolLobbyTeamBuilderLoginSession) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LolLobbyTeamBuilderLoginSession) validateState(formats strfmt.Registry) error {
...
func (m *LolLobbyTeamBuilderLoginSession) UnmarshalBinary(b []byte) error {
	var res LolLobbyTeamBuilderLoginSession
